                ...
                <div class="col d-flex align-items-stretch">
                    <div class="shadow-sm card">
                        <a href="{{ route('ads.show',  Str::slug($advertisement->label)) }}" class="position-relative">
                            <img class="bd-placeholder-img card-img-top" src="storage/{{ $advertisement->image }}" width="100%" height="340" alt="" style="object-fit: cover">
                        ...
                        <div class="card-body d-flex flex-column">
                            <a href="{{ route('ads.show',  Str::slug($advertisement->label)) }}" class="text-decoration-none text-dark">
                            ...
                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-white badge rounded-pill" style="background-color: #717477">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" width="14" height="14"
