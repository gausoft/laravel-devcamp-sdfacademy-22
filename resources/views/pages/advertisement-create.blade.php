...
@section('title') Publier une annonce @endsection

@section('content')

<div class="mx-auto col-md-7 col-lg-8">
    <h4 class="mb-3">Publier une annonce</h4>
    <form class="needs-validation" novalidate method="POST" action="{{ route('ads.store') }}" enctype="multipart/form-data">
        @csrf    
        <div class="row g-3">
            <div class="col-12">
                <label for="label" class="form-label">Titre</label>
                <input type="text" class="form-control @error('label') is-invalid @enderror" id="label" name="label" placeholder="Ex. Groupe électrogène" value="" required>
                @error('label')
            ...
            <div class="col-12">
                <label class="px-4 border @error('image') border-danger is-invalid @enderror w-100 d-flex flex-column align-items-center justify-content-center" style="cursor: pointer; padding-top: 1.5rem; padding-bottom: 1.5rem;">
                    ...
                    <span class="mt-2">Sélectionner un fichier un fichier</span>
            ...
            <div class="col-12">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="5" placeholder="Ex. Objet à louer ..."></textarea>
            </div>

            <div class="col-md-6">
                <label for="cost" class="form-label">Prix <span class="text-muted">(/Jour)</span></label>
                <input type="text" class="form-control @error('cost') is-invalid @enderror" id="cost" name="cost" placeholder="Ex. 15000">
                @error('cost')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('deposit') is-invalid @enderror" id="caution" name="deposit" placeholder="Ex. 6000">
                @error('deposit')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('street') is-invalid @enderror" id="street" name="street" placeholder="Ex. Adidogomé">
                @error('street')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <button class="w-100 btn btn-dark btn-lg" type="submit">Publier</button>
    </form>
</div>
@endsection